...
export class DesignerComponent implements OnInit {
    ...
    @ViewChild('foundry') public foundry : ElementRef;
    colorStops =  ['#FF3300','#FFaa00','#77BB00','#0099FF','#A89361','#6361B9','#7C93B0','#707070']//['#FF0054', '#16C226', '#0099FF','#FF9500','#988BD9','#2EF374','#333333','#707070'];
    ...
    public loadIcons()
    {
        ...
        this.apollo.watchQuery<string>({
             query: gql`
                 query {
                  icons:getIconsByUser(user:"${userId}")
